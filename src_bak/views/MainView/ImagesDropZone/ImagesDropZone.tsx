...
const ImagesDropZone: React.FC<IProps> = ({updateActiveImageIndex, addImageData, updateProjectData, updateActivePopupType, projectData}) => {
    ...
    const loadDefaultImages = async () => {
        //var normalizedPath = '../../../images/';

        //require.context(directory, useSubdirectories = false, regExp = /^**\.\/**/)

        // To solve the problem
        /*const img = require('../../../images/alexander-popov-342444-unsplash.jpg');
        console.log( img );
        const imgFolder = require.context('../../../images/', true)
        for( var actFileName of imgFolder.keys()) {
            
            actFileName = normalizedPath + actFileName.split('./').pop(); // remove the first 2 chars of filename and put path before
            console.log( actFileName );
            let actFile = require( actFileName );
            acceptedFiles.push(actFile);
        }*/
