export enum Action {
    ...
    //KTK (Key to Kungfu)
    UPDATE_IMAGESERIES_META = '@@UPDATE_IMAGESERIES_META',
    UPDATE_IMAGESERIES_CONTENT = '@@UPDATE_IMAGESERIES_CONTENT',
    UPDATE_IMAGESERIES_CONTENT_ROW = '@@UPDATE_IMAGESERIES_CONTENT_ROW',
    UPDATE_SYMBOLS_CONTENT = '@@UPDATE_SYMBOLS_CONTENT',
    ADD_SYMBOLS_CONTENT_ROW = '@@ADD_SYMBOLS_CONTENT_ROW',
    ADD_IMAGESERIES_CONTENT_ROW = '@@ADD_IMAGESERIES_CONTENT_ROW',
}